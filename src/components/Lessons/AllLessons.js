    ...
    <>
      <div className="innerContainer">
        ...
        <p>
          ...
          that the order that words go in when you&rsquo;re speaking Gaelic is a
          little different from English.
        </p>
        <p>
        ...
        translations of the Gaelic, to help you understand what's happening. For
        ...
        <p>
          <br />
          And <b>beag</b> means <em>small</em>, can you work out the Gaelic for
          this?
          <br />
        ...
        <VocabGrid words={["you", "thu", "Anne", "Anna", "John", "Iain", "Callum", "Calum", "Morag", "Mòrag"]} />
        ...
        <p>
          In Gaelic, however, verbs are much, much simpler, and stay the same no
          matter who or what they refer to. That means that you can use the word{" "}
          <em>tha</em> to describe anyone or anything.
        </p>
        ...
        <TransTable words={["Tha mi mòr", "I am big", "Chan eil mi mòr", "I am not big"]} />
        ...
        <TransTable words={["Tha Anna beag", "Anna is small", "Chan eil Anna beag", "Anna is not small"]} />

        <p>
          So just like <em>tha</em>, this means that <em>chan eil</em> cold be
          translated as <em>am not, are not</em> or <em>is not</em> depending on
          the context.
        </p>
        <p>
          Now that we&rsquo;ve learned how to describe what something or someone{" "}
          <em>is</em> or <em>isn&rsquo;t</em>, it&rsquo;s time to learn a few
          more words. The good news is that you can just slot in any other
          adjective you like into this structure. Here are a couple more useful
          ones:
        </p>
        <VocabGrid
